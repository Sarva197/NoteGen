     ...
     <div className="container-fluid mt-3 p-5">
        <div className="row text-center offset-3 p-5">
            <div className="col-8" style={{lineHeight:'1.8'}}>
                <h1 style={{fontSize:'4rem'}}>What will you <br />
                ...
                <a href="" type='button' className='mt-3 mb-4'><button className='btn btn-primary p-3 fs-5' style={{width:'13rem'}}>Get Started</button></a><br />
